...
def search_case_law(keywords: str) -> str:
    """Search for a relevant legal precedent by keyword.

    Args:
        keywords: Search keywords describing the dispute or legal issue.
    """
    cases = {
    ...
    for key, case in cases.items():
        if key in keywords.lower():
            return case
    return "No directly relevant case law found."
