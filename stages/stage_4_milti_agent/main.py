    ...
    messages = [
        SystemMessage(
            content=(
                ...
                'needs_privacy = true → question involves data privacy, GDPR, CCPA, consent, or data breach'
            )
        ),
        HumanMessage(content=state["question"]),
    ]
...
async def call_privacy_specialist(state: LegalState) -> dict:
    ...
    privacy_prompt = (
        ...
        "data breach notification duties, consent requirements, cross-border transfers, and "
        "consumer privacy rights. Use the search_compliance_law tool to ground your analysis. "
...
QUESTION = (
    "If a company breaks a contract, leaks customer data, and avoids taxes, "
    "what are the legal, privacy, and regulatory consequences?"
)
